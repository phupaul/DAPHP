...
class LoginAPI {
    ...
    checklogin() {
        ...
        $.ajax({
            url: "http://localhost/showproduct/FE/user/checklogin.php",
            type: "POST",
            data: data,
    ...
    eVent() {
        ...
        $('#btn_logout').click(function () {
            ...
            setTimeout(function() {
                window.location.href= "/showproduct/FE/index.php"
            }, 3000);
            $('#btn_logout').hide();
        })
        $('#btn-reg').click(function (e) {
            ...
            if (username.length < 6) {
                ...
                _this.Ajax("/showproduct/FE/user/Res.php", data, zone);
            }
        });
        $('#btn_login').click(function (e) {
            ...
            if (username.length < 6) {
                ...
                _this.Ajax("/showproduct/FE/user/login.php", data, zone);
            }
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    if (url == "/showproduct/FE/user/login.php") {
                        ...
                        setTimeout(function () {
                            window.location.href = '/showproduct/FE/user/login.html';
                        }, 3000);
                    }
                } else {
